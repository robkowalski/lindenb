...
private static Element json2xml(Document dom,Object json)
	...
	else if((json instanceof Short)) { xsi="xsd:short";}
	else if((json instanceof Integer)) { xsi="xsd:integer";}
	else if((json instanceof Long)) { xsi="xsd:long";}
	else if((json instanceof Float)) { xsi="xsd:float";}
	else if((json instanceof Double)) { xsi="xsd:double";}
    ...
    public String send(String json) throws IOException
	    {
    	 String urlStr ="http://"+(isUsingTestServer()?"test":"www")+
	    	".freebase.com/api/service/"+getAPIService();
