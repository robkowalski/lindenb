...
private class LeftScalarList extends ScalarList
    {
    LeftScalarList(int row) { super(row);}
    @Override
...
private class TopScalarList extends ScalarList
    {
    TopScalarList(int row) { super(row);}
    @Override
    public ColumnModel getColumnModel() {
...
private class DataScalarList extends ScalarList
    {
    DataScalarList(int row) { super(row);}
    @Override
    public ColumnModel getColumnModel() {
...
private abstract class AbstractPrinter
	...
	protected Pivot getPivot() { return Pivot.this;}
...
private class HTMLPrinter extends AbstractPrinter
	...
	@Override
	protected void oTable(){out.print("<table style=\"border-width:1px;border-style: solid;border-collapse: collapse;border-color: black;\">\n");}
	@Override
	protected void cTable(){out.print("</table>\n");}
	@Override
	protected void oTR() { out.print("<tr class=\"r"+((++trIndex)%2)+"\">"); }
	@Override
	protected void cTR() { out.print("</tr>\n"); }
	@Override
...
private class PlainPrinter extends AbstractPrinter
		...
		@Override
		protected void oTable(){ atBegin=true;}
		@Override
		protected void cTable(){ }
		@Override
		protected void oTR() { atBegin=true; }
		@Override
		protected void cTR() { out.println();atBegin=true; }
		@Override
		protected void TH(String s)
			{
			TD(s);
...
public static void main(String[] args)
    ...
    try {
        ...
        if(optind==args.length)
        	...
        	if(	args[optind].startsWith("http://") ||
        		args[optind].startsWith("https://") ||
        		args[optind].startsWith("file://") ||
        		args[optind].startsWith("ftp://")
        		)
        		{
